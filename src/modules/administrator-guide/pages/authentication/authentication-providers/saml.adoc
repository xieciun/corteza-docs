...
//Editor's note: unless "log off" is specific to the app/sytem/programme..., use "log out".
. The name is displayed on the login form (refer to the <<saml-login-ui,bellow screenshot>>).
